...
function ProfileActivity({ profileUser }) {
    ...
    useEffect ( () => {
        ...
        const fetchPosts = async () => {
            const res = await axios.get(`/api/posts/userId/${profileUser._id}`);
        ...
        const fetchFavourites = async () => {
            const res = await axios.get(`/api/posts/like/${profileUser._id}`);
        ...
        const fetchComments = async () => {
            const res = await axios.get(`/api/comments/userId/${profileUser._id}`);
