    ...
    const handleSubmit = async (e) => {
        ...
        try {
           ...
           await axios.put(`/users/${currentUser._id}`, formData, config);
            ...
            let newUser = await axios.get(`/users?userId=${currentUser._id}`);
                ...
                <form id="form-validation" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <label className="custom-file-upload">
                        ...
                        { file.preview 
                            ...
                            : <img className="avatar-img" src={currentUser.avatar ? `${MEDIA}/profile/${currentUser.avatar}` : `${MEDIA}/profile/defaultAvatar.jpg`} alt="User Avatar" title="Change your profile picture"/>
                        }
                    </label>
